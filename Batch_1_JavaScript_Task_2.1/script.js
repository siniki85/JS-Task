...
function insertData() {
    ...
    lastColumn.innerHTML = `<!-- Button trigger modal -->
    <button type="button" class="btn remove m-1"  onclick="getindex(this)" data-bs-toggle="modal" data-bs-target="#exampleModal">
